...
HRESULT CD3DHelper::RenderFrame(LPDIRECTDRAWSURFACE7 lpDDSSrc,  // source surface
                                ...
                                BYTE videoAlpha,                // fixed rectangle and rescale it here according to
                                                                // the current video window size
                                BOOL bSelectedMovie,            // TRUE if rendering frames of selected channel
								D3DCOLOR framColor)
{
    HRESULT hr = S_OK;
    BYTE alpha = videoAlpha; // alpha-level of the movie frame
    //D3DCOLOR clrFrame = 0xFF006E7F; // color of the frame
	D3DCOLOR clrFrame = 0x00000000; // black frame

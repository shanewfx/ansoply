========================================================================
    ACTIVE TEMPLATE LIBRARY : Ansoply Project Overview
========================================================================

AppWizard has created this Ansoply project for you to use as the starting point for
...
_Ansoply.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_Ansoply.h)
        GUID definitions                                (_Ansoply_i.c)
        A type library                                  (_Ansoply.tlb)
        Marshaling code                                 (_Ansoply_p.c and dlldata.c)
Ansoply.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named Ansoply.pch and a precompiled types file named StdAfx.obj.
...
Ansoplyps.vcproj
	...
	dlldata.c, Ansoply_i.c and Ansoply_p.c which are required
